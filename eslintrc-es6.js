module.exports = {
    "rules":{
         ...
         */
         ...
         //"no-class-asign": "error", // http://eslint.org/docs/rules/no-class-assign
         ...
         "no-restricted-imports": ["error"], // http://eslint.org/docs/rules/no-restricted-imports
         "no-this-before-super": "error", // http://eslint.org/docs/rules/no-this-before-super
         //"no-use-less-computed-key": "error", // http://eslint.org/docs/rules/no-useless-computed-key
